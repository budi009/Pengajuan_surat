...
class Pimpinan extends CI_Controller
{
    ...
    public function QRcode()
    {
        // $data['user'] = $this->db->get_where('user_sistem', ['id_user' => $this->session->userdata('id_user')])->row_array();
        $user = $this->session->userdata('nama_user');
        $qrCode = new Endroid\QrCode\QrCode('sayayayaya');
        $qrCode->writeFile('assets/qrcode/' . 'aku' . '.jpg');
        // $fotoqr = $user . 'jpg';
        // $datasss = array(
        //     'qrcode' => $fotoqr
        // );
    ...
    public function editsuratkp_tolak($id)
    {
        ...
        $this->load->view('pimpinan/template/dashboard_side', $data);
        $this->load->view('pimpinan/template/dashboard_top', $data);
        $this->load->view('pimpinan/editsuratkp_tolak', $data2);
        $this->load->view('pimpinan/template/dashboard_footer');
    }
    public function updatesuratkp_tolak()
    {
        $data['user'] = $this->db->get_where('user_sistem', ['id_user' => $this->session->userdata('id_user')])->row_array();
        $id = $this->input->post('id');
        $tolak = $this->input->post('tolak');
    ...
    public function validasi_pimpinan_prodi(){
        ...
        $this->load->view('pimpinan/template/dashboard_side', $data);
        $this->load->view('pimpinan/template/dashboard_top', $data);
        $this->load->view('pimpinan/suratKP_prodi', $data2);
        $this->load->view('pimpinan/template/dashboard_footer');
    }
}
