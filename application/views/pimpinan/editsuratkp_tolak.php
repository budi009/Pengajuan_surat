                        ...
                        <div class="col-lg-12">
                            ...
                            <section>
                                <?php foreach ($surat_kp as $kp) { ?>
                                    <?= form_open_multipart('pimpinan/updatesuratkp_tolak'); ?>
                                ...
                                <input type="text" readonly id="nama" name="nama" class="form-control" value="<?php echo $kp->nama ?>">
                                    ...
                                    <div class="item form-group">
                                        <div class="col-md-6 col-sm-6 offset-md-4">
                                            <a style="font-size: 14px;" href="<?= base_url('pimpinan/suratkp') ?>"><button type="button" class="col-md-3 btn btn-primary "><i class="fa fa-arrow-left" style="font-size: 17px;"></i> Back</button></a>
