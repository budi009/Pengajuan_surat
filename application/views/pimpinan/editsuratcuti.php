        ...
        <div class="right_col" role="main">
          <div class="col-lg-12">
            ...
            <?= form_open_multipart('pimpinan/updatesuratcuti'); ?>
        ...
        <div class="form-group row">
          <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name"> Nama Lengkap
              ...
              <div class="col-md-6 col-sm-6 ">
               <input type="text" readonly id="nama" name="nama" class="form-control" value="<?php echo $sc->nama ?>">
              </div>
        </div>
        <div class="form-group row">
          <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name"> Program Studi
              ...
              <div class="col-md-6 col-sm-6 ">
                 <input type="text" readonly id="prodi" name="prodi" class="form-control" value="<?php echo $sc->prodi_id ?>">
              </div>
        </div>
        <div class="form-group row">
