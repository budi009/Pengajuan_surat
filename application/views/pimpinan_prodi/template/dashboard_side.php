            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a href="<?= base_url('pimpinan_prodi/index'); ?>" ><i class="fa fa-home"></i> Home </a></li>
                  <li><a href="<?= base_url('pimpinan_prodi/validasi_pimpinan_prodi'); ?>"><i class="fa fa-envelope"></i> Pengajuan Surat </a>
                  </li>
