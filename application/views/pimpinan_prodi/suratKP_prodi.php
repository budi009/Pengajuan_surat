                                      ...
                                      ?>
                                        ...
                                        <?php } else { ?>
                                          <tr>
                                            ...
                                            <td>
                                              <?php if ($kp->penolakan != '') { ?>
                                                <a class="col-md-5 btn btn-primary fa fa-check-square-o disabled " href="<?= base_url('pimpinan_prodi/editsuratkp/') . $kp->id_kp; ?>"></a>
                                                <a class="col-md-5 btn btn-danger fa fa-times-circle disabled" href="<?= base_url('pimpinan_prodi/editsuratkp_tolak/') . $kp->id_kp; ?>"></a>
                                              <?php } elseif ($kp->qrcode != '') { ?>
                                                <a class="col-md-5 btn btn-primary fa fa-check-square-o disabled" href="<?= base_url('pimpinan_prodi/editsuratkp/') . $kp->id_kp; ?>"></a>
                                                <a class="col-md-5 btn btn-danger fa fa-times-circle disabled " href="<?= base_url('pimpinan_prodi/editsuratkp_tolak/') . $kp->id_kp; ?>"></a>
                                              <?php } else { ?>
                                                <a class="col-md-5 btn btn-primary fa fa-check-square-o  " href="<?= base_url('pimpinan_prodi/editsuratkp/') . $kp->id_kp; ?>"></a>
                                                <a class="col-md-5 btn btn-danger fa fa-times-circle  " href="<?= base_url('pimpinan_prodi/editsuratkp_tolak/') . $kp->id_kp; ?>"></a>
