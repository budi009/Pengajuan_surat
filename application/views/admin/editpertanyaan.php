                    ...
                    <div class="right_col" role="main">
                      <div class="col-lg-12">
                        ...
                        <section>
                          <?php foreach ($edit_tanya as $et) { ?>
                            <form action="<?= base_url('admin/updatepertanyaan'); ?>" method="post">
                              ...
                              <div class="form-group row">
                                ...
                                <input type="hidden" id="id" name="id" class="form-control" value="<?php echo $et->id_pertanyaan ?>">
                                    ...
                                    <input type="text" id="pertanyaan" name="pertanyaan" class="form-control" value="<?php echo $et->pertanyaan ?>">
