...
<!-- page content -->
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
            <select name="matkul2" id="matkul2" class="form-control" required>
                <option value="-"> -Pilih Mata Kuliah- </option>
                <?php
                foreach ($dosenmatkul as $dsm) {
                    echo '<option value="' . $dsm->id_mata_kuliah . '">' . $dsm->mata_kuliah . '</option>';
                }
                ?>
            </select>
        </div>
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
            <select name="dosen2" id="dosen2" class="form-control" required> 
    ...
    <div class="radio col-md-3">
        <label id="mg">
            <input type="radio" value="1" id="op1" name="op1"> 1
        </label>


        <label id="mg">
            <input type="radio" value="2" id="op1" name="op1"> 2
        </label>


        <label id="mg">
            <input type="radio" value="3" id="op1" name="op1"> 3
        </label>


        <label id="mg">
            <input type="radio" value="4" id="op1" name="op1"> 4
        </label>


        <label id="mg">
            <input type="radio" value="5" id="op1" name="op1"> 5
        </label>
    </div>
    <br>
    <div class="ln_solid"></div>
...
<script>
  $(document).ready(function() {
    ...
    $('#matkul2').change(function() {
      var id_mata_kuliah = $('#matkul2').val();
      // if(id_mata_kuliah != ''){
      $.ajax({
