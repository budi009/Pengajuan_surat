                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="<?= base_url('user/surat3'); ?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <label class="col-form-label col-md-3 col-sm-3 label-align"></label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="nim3" name="nim3" placeholder="Nim Anggota 3" class="form-control" >
                        </div>
                      </div>
                      <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align"></label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="nim4" name="nim4" placeholder="Nim Anggota 4" class="form-control" >
                        </div>
                      </div>
                      <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align"></label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="nim5" name="nim5" placeholder="Nim Anggota 5" class="form-control" >
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="control-label col-md-3 col-sm-3 label-align"> Tempat KP/MKI <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 ">
