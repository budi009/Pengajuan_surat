      ...
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <div class="form-group row">
              <label class="control-label col-md-3 col-sm-3 label-align">Tahun Angkatan <span style="color: red;" class="required">*</span></label>
              <div class="col-md-6 col-sm-6 ">
            ...
            <div class="form-group row">
              <label class="control-label col-md-3 col-sm-3 label-align">Tahun Akademik <span style="color: red;" class="required">*</span></label>
              <div class="col-md-6 col-sm-6 ">
            ...
            <div class="item form-group">
              <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Nama Orang Tua <span style="color: red;" class="required">*</span></label>
              <div class="col-md-6 col-sm-6 ">
            ...
            <div class="item form-group">
              <label class="col-form-label col-md-3 col-sm-3 label-align">Alamat Lengkap <span style="color: red;" class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 ">
            ...
            <div class="item form-group">
              <label class="col-form-label col-md-3 col-sm-3 label-align">Pekerjaan <span style="color: red;" class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 ">
            ...
            <div class="item form-group">
              <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Scan KTP Ortu <span style="color: red;" class="required">*</span></label>
              <div class="col-md-6 col-sm-6 ">
                <input id="ktp_ortu" class="form-control" type="file" name="ktp_ortu" required="required">
              </div>
            </div>
            <div class="item form-group">
              <label class="col-form-label col-md-3 col-sm-3 label-align">Scan KTM <span style="color: red;" class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 ">
            ...
            <div class="item form-group">
              <label class="col-form-label col-md-3 col-sm-3 label-align">Scan Pedoman Akademik <span style="color: red;" class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 ">
            ...
            <div class="item form-group">
              <label class="col-form-label col-md-3 col-sm-3 label-align">Keperluan Surat <span style="color: red;" class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 ">
                <textarea id="keperluan" required placeholder="cth: Untuk Lomba di Banyuwangi" name="keperluan" class="date-picker form-control" type="text"></textarea>
              </div>
            </div>
            <br>
            <br>
