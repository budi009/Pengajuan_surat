         ...
         <li role="presentation" class="nav-item dropdown open">
           <a href="javascript:;" class="dropdown-toggle info-number" id="navbarDropdown1" data-toggle="dropdown" aria-expanded="false">
             <i class="fa fa-bell">
               <?php
                if ($jml_kp_baca2 > 0) { ?>
                 <span class="badge bg-red"><?php echo  $jml_kp_baca2 ?></span>
               <?php } else { ?>
           ...
           <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
             ...
             <li class="nav-item">
               <a class="dropdown-item" href="<?= base_url('adminprodi/surat'); ?>" method="post">
                 <?php
                  if ($jml_kp_baca2 > 0) { ?>
                   <span>
                     <span>Surat Kerja Praktek </span>
                   </span>
                   <?php if ($jml_kp_baca2 == 0) { ?>
                     <span class="message">
                       Tidak ada permintaan
                     </span>
                   <?php } else { ?>
                     <span class="message">
                       <?php echo $jml_kp_baca2 ?> Surat pengajuan baru
                     </span>
                   <?php } ?>
                 <?php } else { ?>
                   <span>
